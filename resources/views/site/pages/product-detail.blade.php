                    ...
                    <div class="col-md-6">
                        <figure class="card card-product">
                            <div class="img-wrap padding-y">
                                <img src="https://cdn.dribbble.com/userupload/13283412/file/original-64b7ed7c9829096713babb98b5953ebe.jpg?resize=1024x768" alt="">
                            </div>
                                ...
                                @if ($product->price != 0)
                                    <div class="price-wrap h5">
                                        <span class="price pull-right"> 
                                            {{ config('services.currency_symbol').' : '.$product->price }} 
                                        </span>
                                    </div>
                                @endif
                            </div>
